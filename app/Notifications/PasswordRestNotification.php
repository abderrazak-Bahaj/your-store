...
class PasswordRestNotification extends Notification
{
    ...
    {
        $this->url =  'http://127.0.0.1:8000/reset-password?token='. $token;
    }
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line(Lang::get('If you did not request a password reset, no further action is required.URL ===> '.$this->url ));
    }
